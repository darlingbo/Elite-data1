    ...
    <>
      ...
      <aside className={`fixed top-0 left-0 bottom-0 z-50 w-72 bg-linear-to-b from-blue-900 to-blue-800 flex flex-col transition-transform duration-300 ${open ? "translate-x-0" : "-translate-x-full"}`}>
        ...
        <div className="px-5 py-5 border-b border-white/10 flex items-center justify-between">
          ...
          <button onClick={() => setOpen(false)} className="p-2 rounded-xl text-white/60 hover:text-white hover:bg-white/10 transition-colors">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
        ...
        <div className="px-4 pb-6 pt-3 border-t border-white/10">
          <Link
            ...
            className="flex items-center justify-center gap-2 w-full bg-yellow-400 hover:bg-yellow-300 text-gray-900 font-black py-3.5 rounded-2xl text-sm transition-colors shadow-lg"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center justify-center gap-2 w-full mt-2 text-green-300 hover:text-green-200 text-xs font-semibold py-2 transition-colors"
          >
