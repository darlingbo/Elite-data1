...
export default function WhatsAppButton({ phone = "233509794503" }: { phone?: string }) {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold px-4 py-3 rounded-full shadow-2xl transition-all hover:scale-105 active:scale-95 group"
    >
