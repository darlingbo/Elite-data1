...
export async function GET() {
  ...
  const [mtn, telecel, at, mashup, autoHours, autoStart, autoEnd, inventor, datacity, datify, slowDelivery] = await Promise.all([
  ...
  return Response.json({ mtn: mtn === "1", telecel: telecel === "1", at: at === "1", mashup: mashup === "1", autoHours: autoHours === "1", autoStart, autoEnd, inventor: inventor === "1", datacity: datacity === "1", datify: datify === "1", slowDelivery: slowDelivery === "1" });
}
