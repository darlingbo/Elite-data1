...
export const metadata: Metadata = {
  title: "Page Not Found | Elite Data Ghana",
  description: "The page you are looking for does not exist. Go back to the Elite Data homepage to buy cheap data bundles in Ghana.",
...
export default function NotFound() {
  return (
    <div style={{ background: BG, minHeight: "70vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "48px 16px" }}>
      <div style={{ textAlign: "center", maxWidth: 480 }}>
        ...
        <div style={{
          ...
          background: `linear-gradient(135deg, ${YELLOW}, #fb923c)`,
        ...
        <div style={{
          ...
          <p style={{ color: MUTED, fontSize: 15, lineHeight: 1.65, margin: 0 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <Link
            ...
            style={{
              ...
              padding: "14px 24px", borderRadius: 14, textDecoration: "none", fontSize: 15,
            }}
          >
            ⚡ Buy Data Bundles
          </Link>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            <Link
              ...
              style={{
                ...
                color: TEXT, fontWeight: 600, padding: "12px 16px",
